...
global.rpg = {
  ...
  role(level) {
    ...
    const role = [
      ...
      { name: "Semi-droid", level: 32 }, { name: "Nitro", level: 36 },
      { name: "Semi-droid", level: 48 }, { name: "turbo", level: 52 }, 
      { name: "Super-droid", level: 56 }, { name: "Super-turbo-nitro", level: 60 }, 
      { name: "DIOS-DROID", level: 100 }
    ];
